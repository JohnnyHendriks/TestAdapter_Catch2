...
namespace CatchTestset02
{
    ...
    TEST_CASE_METHOD(TestFixture, "Testset02Tests02LongName01234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789", "[Testname]")
    {
        CHECK( x == y );
    }

    TEST_CASE_METHOD(TestFixture, "Testset02.Tests02. LongName 0123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789", "[Testname]")
    {
        CHECK( x == y );
    }

    TEST_CASE_METHOD(TestFixture, "Testset02.Tests02. LongName 0123456789-01234567890123456789-01234567890123456789-01234567890123456789-01234567890123456789-0123456789", "[Testname]")
    {
        CHECK( x == y );
    }
