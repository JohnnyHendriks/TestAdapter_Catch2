...
{
    [TestClass]
    public class ListTestsXmlTestsDll
    {
        #region Properties
        ...
        public void AllIncludeHidden(string versionpath)
        {
            ...
            var source_dummy = Paths.TestDll_Dummy(TestContext, versionpath);
            ...
            settings.General.DiscoverCommandLine = "--list-tests --reporter xml *";
            settings.General.DllFilenameFilter = new Regex(".*");
            ...
            tests = discoverer.GetTestsDll(sources2) as List<TestCase>;
        ...
        public void AllNoHidden(string versionpath)
        {
            ...
            var settings = new SettingsManager();
            settings.General.DiscoverCommandLine = "--list-tests -r xml *";
            settings.General.DllFilenameFilter = new Regex(".*");
            settings.General.DllRunner = @"${dllpath}/CatchDllRunner.exe";
            settings.General.DllRunnerCommandLine = @"${catch2} ${dll}";
        ...
        public void Tag1IncludeHidden(string versionpath)
        {
            ...
            var settings = new SettingsManager();
            settings.General.DiscoverCommandLine = "--list-tests -r xml [Tag1]";
            settings.General.DllFilenameFilter = new Regex(".*");
            settings.General.DllRunner = @"${dllpath}/CatchDllRunner.exe";
            settings.General.DllRunnerCommandLine = @"${catch2} ${dll}";
            settings.General.IncludeHidden = true;
        ...
        {
            var source = Paths.TestDll_Discover(TestContext, versionpath);
            if (string.IsNullOrEmpty(source))
            {
                Assert.Fail($"Missing test executable for {versionpath}.");
                return;
            ...
            var settings = new SettingsManager();
            settings.General.DiscoverCommandLine = "--list-tests -r xml \"Tags. Manytags\"";
            settings.General.DllFilenameFilter = new Regex(".*");
            settings.General.DllRunner = @"${dllpath}/CatchDllRunner.exe";
            settings.General.DllRunnerCommandLine = @"${catch2} ${dll}";
        ...
        public void LongTag1(string versionpath)
        {
            ...
            var settings = new SettingsManager();
            settings.General.DiscoverCommandLine = "--list-tests -r xml \"Tags. Longtag1\"";
            settings.General.DllFilenameFilter = new Regex(".*");
            settings.General.DllRunner = @"${dllpath}/CatchDllRunner.exe";
            settings.General.DllRunnerCommandLine = @"${catch2} ${dll}";
        ...
        public void LongTag2(string versionpath)
        {
            ...
            var settings = new SettingsManager();
            settings.General.DiscoverCommandLine = "--list-tests -r xml \"Tags. Longtag2\"";
            settings.General.DllFilenameFilter = new Regex(".*");
            settings.General.DllRunner = @"${dllpath}/CatchDllRunner.exe";
            settings.General.DllRunnerCommandLine = @"${catch2} ${dll}";
        ...
        public void Names(string versionpath)
        {
            ...
            var settings = new SettingsManager();
            settings.General.DiscoverCommandLine = "--list-tests --reporter xml *TestCases*";
            settings.General.DllFilenameFilter = new Regex(".*");
            settings.General.DllRunner = @"${dllpath}/CatchDllRunner.exe";
            settings.General.DllRunnerCommandLine = @"${catch2} ${dll}";
        ...
        public void NamesVerbose(string versionpath)
        {
            ...
            var settings = new SettingsManager();
            settings.General.DiscoverCommandLine = "-v high --list-tests -r xml *TestCases*";
            settings.General.DllFilenameFilter = new Regex(".*");
            settings.General.DllRunner = @"${dllpath}/CatchDllRunner.exe";
            settings.General.DllRunnerCommandLine = @"${catch2} ${dll}";
        ...
        public void LongNames(string versionpath)
        {
            ...
            var settings = new SettingsManager();
            settings.General.DiscoverCommandLine = "--list-tests --reporter xml LongTestCaseNames*";
            settings.General.DllFilenameFilter = new Regex(".*");
            settings.General.DllRunner = @"${dllpath}/CatchDllRunner.exe";
            settings.General.DllRunnerCommandLine = @"${catch2} ${dll}";
        ...
        public void LongNamesVerbose(string versionpath)
        {
            ...
            var settings = new SettingsManager();
            settings.General.DiscoverCommandLine = "-v high --list-tests -r xml LongTestCaseNames*";
            settings.General.DllFilenameFilter = new Regex(".*");
            settings.General.DllRunner = @"${dllpath}/CatchDllRunner.exe";
            settings.General.DllRunnerCommandLine = @"${catch2} ${dll}";
        ...
        public void LongNamesNotDiscoverable(string versionpath)
        {
            ...
            var settings = new SettingsManager();
            settings.General.DiscoverCommandLine = "--list-tests -r xml NotDefaultDiscoverable*";
            settings.General.DllFilenameFilter = new Regex(".*");
            settings.General.DllRunner = @"${dllpath}/CatchDllRunner.exe";
            settings.General.DllRunnerCommandLine = @"${catch2} ${dll}";
        ...
        public void LongNamesNotDiscoverableVerbose(string versionpath)
        {
            ...
            var settings = new SettingsManager();
            settings.General.DiscoverCommandLine = "-v high --list-tests -r xml NotDefaultDiscoverable*";
            settings.General.DllFilenameFilter = new Regex(".*");
            settings.General.DllRunner = @"${dllpath}/CatchDllRunner.exe";
            settings.General.DllRunnerCommandLine = @"${catch2} ${dll}";
        ...
        {
            var source = Paths.TestDll_Duplicates(TestContext, versionpath);
            if (string.IsNullOrEmpty(source))
            {
                Assert.Fail($"Missing test executable for {versionpath}.");
                return;
        ...
        public void Timeout(string versionpath)
        {
            ...
            var settings = new SettingsManager();
            settings.General.DiscoverCommandLine = "--sleep 500 --list-tests -r xml *";
            ...
            settings.General.DiscoverCommandLine = "--sleep 50 --list-tests -r xml *";

            tests = discoverer.GetTestsDll(sources) as List<TestCase>;
